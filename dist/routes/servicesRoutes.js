...
const serviceSchemas_1 = require("../validators/serviceSchemas");
...
router.post('/', auth_1.authenticateToken, (0, permissions_1.checkPermission)('canEditServices'), (0, validation_1.validateBody)(serviceSchemas_1.createServiceSchema), servicesController_1.createService);
router.put('/:id', auth_1.authenticateToken, (0, permissions_1.checkPermission)('canEditServices'), (0, validation_1.validateBody)(serviceSchemas_1.updateServiceSchema), servicesController_1.updateService);
