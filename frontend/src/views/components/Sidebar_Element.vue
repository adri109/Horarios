...
<template>
  <div
    :class="[
      'sidebar hidden md:block flex-shrink-0 h-full overflow-y-auto text-white',
    ...
    <div class="p-4 md:p-5">
      <div class="sidebar-top">
        <div class="brand-wrap">
          <router-link
            to="/dashboard/resume"
            class="sidebar-brand-link block transition-opacity hover:opacity-90"
            :aria-label="`${BRAND.appName} — ${BRAND.dashboardLabel}`"
          >
            <BrandLogo variant="fullWhite" size="sm" class="sidebar-brand-logo sidebar-brand-logo--full" />
            <BrandLogo variant="iconWhite" size="sm" class="sidebar-brand-logo sidebar-brand-logo--icon" />
          </router-link>
        </div>
        <div class="flex items-center gap-1 shrink-0">
          <button
            type="button"
            class="toggle-btn hidden md:inline-flex"
            @click="emit('toggle')"
        ...
        <ul>
          ...
          <li class="mb-4">
            ...
            >
              ...
              <span class="sidebar-nav-label">{{ BRAND.dashboardLabel }}</span>
            </router-link>
          </li>
          ...
          <li class="mb-4">
            ...
            >
              ...
              <span class="sidebar-nav-label">Citas</span>
            </router-link>
          </li>
          ...
          <li v-if="canViewPersonal" class="mb-4">
            ...
            >
              ...
              <span class="sidebar-nav-label">Personal</span>
            </router-link>
          </li>
          ...
          <li v-if="canViewServices" class="mb-4">
            ...
            >
              ...
              <span class="sidebar-nav-label">Servicios</span>
            </router-link>
          </li>
          ...
          <li v-if="canViewReports" class="mb-4">
            ...
            >
              ...
              <span class="sidebar-nav-label">Informes</span>
            </router-link>
          </li>
          ...
          <li v-if="canViewMarketing" class="mb-4">
            ...
            >
              ...
              <span class="sidebar-nav-label">Marketing</span>
            </router-link>
          </li>
...
.sidebar.is-collapsed .sidebar-brand-logo--full {
  display: none;
}

.sidebar.is-collapsed .sidebar-brand-logo--icon {
  display: block;
  margin: 0 auto;
}
